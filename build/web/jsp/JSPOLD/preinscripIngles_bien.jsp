                  ...
                  <td> 
                    <div align="center"><font face="Verdana, Arial, Helvetica,sans-serif" size="1"> 
                      <select size="1" name="idasig">
                        <option value="843">Inglés Nivel 1 - Parte A</option>
                        <option value="846">Inglés Nivel 1 - Parte B</option>
                        <option value="853">Inglés Nivel 2 - Parte A</option>
                        <option value="856">Inglés Nivel 2 - Parte B</option>
                        <option value="863">Inglés Nivel 3 - Parte A</option>
                        <option value="866">Inglés Nivel 3 - Parte B</option>
                        <option value="873">Inglés Nivel 4 - Parte A</option>
                        <option value="876">Inglés Nivel 4 - Parte B</option>
                      </select>
                      </font> </div>
                  </td>
                </tr>
