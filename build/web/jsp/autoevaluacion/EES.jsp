...
<%
        ...
        Vector Datos = est.Contesto(carnet, "133");
...
<SCRIPT LANGUAGE="JavaScript">
    function comprueba( ){
        for(i=1; i<53; i++){
         ...
         if (i==16 || i==17 || i==18 || i==19 || i==20 || i== 21 || i== 22 || i== 23  || i== 36 || i== 37){
...
<p class="Centro" align="center"><strong>Encuesta Estudiantes</strong></p>
  ...
  <table width="98%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">El proceso de asignaci&oacute;n de consejeros 
        y el apoyo que estos ofrecen a los estudiantes con dificultades acad&eacute;micas 
        han sido: </td>
      ...
      <td width="12%" align="center" colspan="2">Nada efectivos</td>
    </tr>
    <tr> 
      <td width="11%" align="center"> 
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%"> Las relaciones de cooperaci&oacute;n acad&eacute;mica, 
        movilidad y pr&aacute;cticas han incidido en el enriquecimiento de la 
        calidad del programa:</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr> 
      ...
      <td width="6%" align="center">
        <input type="radio" name="P36" value="0">
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="6%" align="center"> 
        <input type="radio" name="P37" value="0">
      </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%"> Los servicios de bienestar tienen cobertura 
        por su variedad</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%"> La capacidad de los laboratorios, talleres 
        y espacios para pr&aacute;ctica (con simuladores, espacios virtuales, 
        adem&aacute;s de laboratorios) para atender el n&uacute;mero de estudiantes 
        del programa es suficiente. </td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
      <td width="11%" align="center">En desacuerdo</td>
    ...
    <tr> 
      ...
      <td rowspan="2" width="38%">Los equipos y materiales de los laboratorios 
        y espacios para pr&aacute;cticas (incluye simuladores y espacios virtuales) 
        son adecuados con la naturaleza y las exigencias acad&eacute;micas del 
        programa.</td>
      <td width="11%" align="center">Totalmente de acuerdo</td>
      <td width="11%" align="center">De acuerdo</td>
      <td width="11%" align="center">Parcialmente de acuerdo</td>
