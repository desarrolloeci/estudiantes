...
if (solicitud.elementAt(7).toString().equals("C"))
    doc = "C.C. No. ";
else if (solicitud.elementAt(7).toString().equals("T"))
    doc = "T.I. No. ";
else if (solicitud.elementAt(7).toString().equals("P"))
    doc = "Pasaporte. No. ";
else if (solicitud.elementAt(7).toString().equals("E"))
    doc = "Cédula Extranjería. No. ";     

%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
        <title>Servicios Acad&eacute;micos - Grado</title>
    ...
    <body id="public"  onload="imprim()" style="background-color: white">
      ...
      <%if(impr == null){%>
                ...
                <tr>
                    ...
                    <fieldset>
                    <div align="left">
                      <legend>Bogotá, D. C. <!%=despinfopar.elementAt(3)%> </legend>
                      &nbsp;
                    </div>
                    <p>Se&ntilde;ores<br>
        ...
        <p>Muy comedidamente me permito presentar a su consideraci&oacute;n la 
          solicitud de aprobaci&oacute;n de mi grado de <strong><%=datosestud.elementAt(1)%></strong>, 
          teniendo en cuenta que he terminado satisfactoriamente el plan de estudios 
          correspondiente y he cumplido con los requisitos legales y reglamentarios 
          exigidos.</p>              
                  ...
                  <p><%=datosestud.elementAt(0)%><br>
                    ...
                    <%=doc%> <%=solicitud.elementAt(6)%> de <%=solicitud.elementAt(17)%><br>
