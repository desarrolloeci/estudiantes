...
<html>
    <head>
        ...
        <title>Servicios Acad&eacute;micos - Servicio no disponible</title>
        ...
        <div id="container">
            <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                ...
                <tr>
                    <td>
                        <br>
                    <strong>Este servicio no se encuentra disponible actualmente</strong><br></td>
                </tr>
            </table>
        </div><!--container-->
...
<%
                ...
                correo.enviar("No disponible estudiantes", e.getMessage());
            }
%>