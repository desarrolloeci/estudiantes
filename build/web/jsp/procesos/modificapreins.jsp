...
<%
            ...
            int i, crtot, cras, cradic, totalcred = 0, lab = 0;
...
<html>
    ...
    <script language="JavaScript" type="text/JavaScript">
        ...
        function conectar(url,funcion){
         ...
         function desPreinscribir(){
            ...
            var url='ModificaPreinsNvo?identificador='+identificador+'&valor=0';
    ...
    <body>
        <!--!dpto.equals("15") &&-->
        <%if ((!estado.equals("3") || !estado.equals("7"))) {%>
                ...
                <tr>
                    <td colspan="2">
                        <div class="info" align="center">
                            ...
                            <h2><font color="#666666"> <label id="msj">Preinscripci&oacute;n 2020-2 </label>
                                       <div id="mensaje1" align="center" style="color: red;visibility:hidden">
                            <p>No puede eliminar esta asignatura</p> </div>
            ...
            <td width="68%" valign="top"> <b> 
              ...
              <table width="96%" border="1" class="tabla">
                ...
                <% for (i = 0; i < lispre.size(); i++) {
                                                    ...
                                                    String idasig =  (String) preadic.elementAt(2);
                                                    String cdlab = (String) preadic.elementAt(3);
                                                    lab = Integer.parseInt(cdlab);
                                                    String deplab = (String) preadic.elementAt(4);%>
               <!--asi estaba -->
                <tr id="<%=preadic.elementAt(2)%>"> 
                 ...
                 <td width="19%" id="columna"><%=(String) preadic.elementAt(5)%></td>
          ...
          <tr> 
            ...
            <td width="25%" valign="top"> 
              <form name="form1" method="get" action="javascript:ventanaSecundaria('BuscarAsig')">
                ...
                <input type="submit" name="Input" value="Enviar" >
              </form>
            </td>
          </tr>
        </table>
        <div align="center"> </div>
            ...
            <%} else {%>
            <CENTER>Usted no debe realizar este proceso.</CENTER>
            <%}
            %>
        </div>
    </body>
