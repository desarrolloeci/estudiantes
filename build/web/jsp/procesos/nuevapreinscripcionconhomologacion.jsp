...
<html>
    ...
    <script language="JavaScript" type="text/JavaScript">
        function opcionesModal(idCampoExt,idCampoInt,Datos,respLink){
            ...
            window.showModalDialog("html/Opciones/Estados.html",Datos,"dialogHeight:"+largo+"px;dialogWidth:200px;dialogLeft"+window.height/2+"px;dialogTop:"+window.width/2+"px");
            if(Datos[2] == "Ok")
            {
        ...
        function getCodigos(valor){
            return [valor+'='+valor,'H1=H1','EE1=EE1','SPPC=SPPC','LISTO=LISTO'];
        }
                        ...
                        <table width="100%" border="0" align="center" class="tabla">
                            ...
                            <tr>
                                <td width="60%" valign="top"> <b>
                                    ...
                                    <table width="100%" border="1" class="tabla">
                                        <tbody id="preinscritas">
                                            <tr>
                                                ...
                                                <td width="11%">Créd</td>
                                                <td width="22%">
                                                    <div align="center">Homologar por</div>
                                                </td>
                                                <td width="22%">Seleccione</td>
                                            </tr>
                                            <%  crtot = 0;
                                                        cradic = 0;
                                            ...
                                            <tr id="<%=preadic.elementAt(5)%>">
                                                ...
                                                <td width="22%" id="columna">
                                                    <input type="text" disabled="true" size="10" id="mat<%=preadic.elementAt(5)%>" value="<%=preadic.elementAt(7)%>"/><a href="#" onClick="return opcionesModal('mat<%=preadic.elementAt(5)%>','mat<%=preadic.elementAt(5)%>',getCodigos('<%=preadic.elementAt(0)%>'),true);"><img ALIGN="MIDDLE" alt="" src="img/selector.gif"/></a>
                                                </td>
                                                <td width="22%" id="columna">
                                    ...
                                    <p>&nbsp;</p><form name="form3" method="post" action="">
                                        <div align="center">
                                            <p>
                                                <input type="submit" name="Submit3" value="Guardar Homologación">
                                            </p>
                                        </div>
                                    </form>
                                    <p>&nbsp;</p>
