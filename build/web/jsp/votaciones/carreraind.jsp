...
<form method="post" action="guardavotos">
  <table border="0" cellspacing="0" cellpadding="0" width="700">
    <tr>
      <td height="10" valign="top" width="725"><font face="Impact" size="3"> Comité  carrera&nbsp;&nbsp; <img src="img/gris.jpg" width="380" height="3"> </font><p>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td height="5" width="500">&nbsp; <table border="1" align="center" width="500">
        <tr>
          <td width="724" align="center"><table border="0" width="100%">
            <tr>
              <td width="100" rowspan="2"><img src="img/Morales1.jpg" width="100" height="110"
              alt="wpe133.jpg (3748 bytes)" align="right"></td>
              <td width="80" rowspan="2">&nbsp;
                    <p><font size="1"><strong>INGRID CATALINA MORALES BASTIDAS</strong></font></p>
              <p>&nbsp;</td>
          ...
          <td width="362" align="center"><table border="0" width="242">
            <tr>
              <td width="100" rowspan="2"><img src="img/Uribe1.jpg" width="100" height="110"
              alt="wpe133.jpg (3748 bytes)" align="right"></td>
              <td width="80" rowspan="2">&nbsp;
                    <p><font size="1"><strong>JULIANA URIBE REYES</strong></font></p>
              <p>&nbsp;</td>
    ...
    <tr align="center">
      <td height="24" valign="top" width="725">
        <table border="1" width="100%">
          ...
          <input  type="hidden" name="codcrp" value="16">
