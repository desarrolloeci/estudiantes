<%@ include file="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/secure.jsp" %>
    ...
    <body id="public">
        <div id="container">
            <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                <tr>
                    <td colspan="2" bgcolor="#EEEEEE"><img src="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/Temp/img/top.gif" alt="" width="770" height="10" id="top" /></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td align="center" valign="top" colspan="2">
                        <div id="Layer1">
                            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="380" height="22" class="visibleflash" id="cargando">
                                <param name="movie" value="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/Temp/img/flash/barraload.swf">
    ...
    l = l + 1;%>
                                ...
                                <tr align="center">
                                    <td colspan="3">
                                        <div align="center"><br>
                                            <font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                                                <input type="button" name="Submit" value="Enviar Solicitud" onclick="refreshModelList()" id="Submit1">
                                        </font> </div>
                                    </td>
                                </tr>
                                <tr>
    ...
    que ya tiene en registro.-->
                        ...
                        <div id="Layer2">
                            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="380" height="22" class="visibleflash" id="cargando2">
                                <param name="movie" value="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/Temp/Temp/img/flash/barraload.swf">
                                <param name="quality" value="high">
                                <embed src="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/Temp/Temp/img/flash/barraload.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="380" height="22"></embed>
                            </object>
                        </div>
    ...
    while (!(texto[j].equals("fin"))) {
        ...
        j = j + 1;
                        ...
                        <center>
                            ...
                            NO ES HOY.--></font></H4>
                            <P>
                            <h3><font size="2"><a href="file:///C|/DOCUME%7E1/LRODRI%7E1/CONFIG%7E1/Temp/Temp/matriculaEstudJava"><font face="Verdana, Arial, Helvetica, sans-serif">Solicitud
