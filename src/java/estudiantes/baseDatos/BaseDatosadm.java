...
import java.sql.*;
import java.net.*;
//import intraeci.configuracion.configECI1;
...
public class BaseDatosadm {
    ...
    //protected 	String dbUrl = "jdbc:freetds:sqlserver://10.1.1.40/REGISTRO";
    configECI conf=new configECI();
    
	protected 	String dbUrl = "jdbc:jtds:sqlserver://"+conf.getIPBd()+"/REGISTRO";
    /**
