 ...
 * FiltroLogin.java
 *
 * Created on 17 de agosto de 2007, 02:28 PM
 */
...
public class FiltroLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        estudiantes.filtros.encripta enc = new estudiantes.filtros.encripta(56);
	session.setAttribute("carnetenc", enc.encriptar(carnet));
	session.setAttribute("passwdenc", enc.encriptar(passwd));
        session.setAttribute("llave", enc.getLlave());
        try {
