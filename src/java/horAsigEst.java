...
public class horAsigEst extends HttpServlet
{    
    configECI cfgEci;
...
//Operaciones normales
              ...
              " registro.grupo.per_acad = ? and  registro.sal_grupo.per_acad = ? and" +
                //Para periodo intermedio '2019-I'
                //"registro.grupo.per_acad = '" + "2019-I" + "' and  registro.sal_grupo.per_acad = '" + "2019-I" + "' and" +
               //LO DEJO SIN PERIODO PARA INHABILITAR LA BUSQUEDA DESPUES DE FINALIZAR OPERACIONES DE REGISTRO ACADEMICO O SEMANA DE REGISTRO y comentarizo linea con periodo linea 116
              // " registro.grupo.per_acad = '' and  registro.sal_grupo.per_acad = '' and  " +
                "  id_profesor = id_prof " +
