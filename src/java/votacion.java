...
public class votacion extends HttpServlet {
    ...
    public void validacarrera(PrintWriter out, BaseDatos bd, String consulta,
        ...
        if (lista.size() <= 0) {
            ...
            if ((vcd.equals("1")) && (vca.equals("1")) && (vprg1.equals("1")) && (vprg2.equals("2"))) {
                out.println("<center>");
                out.println("<p class=\"textocom\">Usted ha terminado el proceso de votación</p>");
                out.println("<p class=\"textocom\"><b><a href=\"../estudiantes/login?msg=4\"> Salir</a></b></center></p>");
            }
            ...
            if (vcd.equals("0")) {
                ...
                out.println("       <td>");
                out.println("           <b>");
                out.println("           CONSEJO DIRECTIVO11");
                out.println("           </b>");
                out.println("       </td>");
                out.println("   </tr>");
                out.println("   </form>");
            ...
            if (vca.equals("0")) {
                ...
                out.println("       <td>");
                out.println("           <b>");
                out.println("           CONSEJO ACADEMICO22");
                out.println("           </b>");
                out.println("       </td>");
                out.println("   </tr>");
                out.println("   </form>");
      ...
      /*if ((vcd.equals("1")) && (vca.equals("1")) && (vprg1.equals("1"))) {
        out.println("<center>");
        out.println("<p>");
        out.println("Usted ya votó por todos los cuerpos colegiados, muchas gracias por su participación");
        out.println("</p>");
