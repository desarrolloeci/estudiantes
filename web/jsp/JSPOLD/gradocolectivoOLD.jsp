...
<table width="640" border="0" cellpadding="0" align="center" cellspacing="0">
    ...
    <td width="640" valign="top"> 
      ...
      <table width="100%" border="0" align="center" class="texto1">
        ...
        <tr> 
          <td valign="top">
              <div align="left">Bogot&aacute; D. C., <%=despingopar.elementAt(3)%> </div>
              <p align="left"><br>
              ...
              <p align="justify"><strong>1.</strong>	Aprobaci&oacute;n de su Grado por parte del
                ...
                de
                  Ley, y expedici&oacute;n del Acta de Grado correspondiente.</p>
              <p align="justify"><strong>2. </strong>Entrega del diploma que lo acredita como profesional egresado
              ...
              <p align="justify">Con el objetivo de poder cumplir con la organizaci&oacute;n
                  de la Ceremonia de Grados Colectiva, que para esta promoci&oacute;n
                  ...
                  de la ESCUELA programada para el d&iacute;a <strong><%=despingopar.elementAt(2)%></strong></p>
              <p align="justify">Si por alguna eventualidad, usted no puede cumplir con los
                  ...
                  no podr&aacute; ser incluido en la Ceremonia de Grado Colectiva
                  del <strong><%=despingopar.elementAt(5)%></strong></p>
              <p align="justify">Queda entonces, la opci&oacute;n, de recibir su diploma en
                  la siguiente Ceremonia Colectiva correspondiente a la promoci&oacute;n 
                  <strong><%=despingopar.elementAt(6)%></strong> o recibir su diploma de manera individual en fecha acordada
            ...
            <div align="center"><a href="InstGradoColectivo"><strong>&lt;&lt; CONTINUAR &gt;&gt;</strong></a></div></td>
        </tr>
        <tr> 
