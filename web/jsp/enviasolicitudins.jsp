...
<%  
	...
	String cont = new String((String)session.getAttribute("cont1"));
  ...
  for (int j=0; j<k; j++){   
    ...
    <%if (m1 == 0){%>
            ...
            <CENTER>
              <p> 
              <h4><br>
                <font face="Verdana, Arial, Helvetica, sans-serif">USTED NO SELECCIONO 
                NINGUNA OPERACION. O NO ESCRIBIO EL GRUPO A MODIFICAR.</font></H4>
            </CENTER>
...
valor m: <%=m%><br>-->
            ...
            <div align="center"> 
              <p><br>
                <font face="Verdana, Arial, Helvetica, sans-serif"><b>Despu&eacute;s 
                de enviar su solicitud, consulte y verifique el horario.</b><BR>
                <br>
                </font> 
    ...
    Operacion op2 = new Operacion (carnet,sol) ;
        if(op2.ejecutarOperacion()){
            for ( int i = 0 ; i < m ; i++ ){
                ...
                <!--Sol no: <%=i%>&nbsp; - &nbsp;
                Operacion: <%=soll.getTipOp()%>&nbsp; - &nbsp;  
                Asignatura: <%=soll.getCodAsig()%>&nbsp; - &nbsp;                                                            
                Grupo: <%=soll.getNumGrp()%>&nbsp; - &nbsp;
                Lab: <%=soll.getNumLab()%>&nbsp; - &nbsp;  
                Aux: <%=soll.getNumAux()%>&nbsp; - &nbsp;  
                Respuesta: <%=soll.getRespuesta()%><br> -->
                <%if(soll.getRespuesta() == 'S')
                     respuesta="Su solicitud fue aceptada";
                else if(soll.getRespuesta() == 'A')
                     respuesta="Código de asignatura no existente";
                     ...
                     respuesta="El grupo a inscribir no existe";
                     ...
                     respuesta="Problema con el Laboratorio, Retire la asignatura <br> y adicionela en el nuevo grupo deseado";
