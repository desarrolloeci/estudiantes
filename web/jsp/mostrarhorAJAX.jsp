...
function refreshModelList(asig) {
    var url = "ServAjax?iden=" + asig + "&func=horasigest";
    nombreasig = asig;
...
function updateList() {
    var numgr, nomd, horai, horaf, salon, disp, profesor, mensaje;
    var List = document.getElementById("List");
    var results = xmlHttp.responseXML.getElementsByTagName("numgrupo");
    mensaje = "";
    if(results.length>0){
        for(var i = 0; i < results.length; i++) {
            numgr = results[i].firstChild.nodeValue;
            mensaje = mensaje + numgr + "\n";                  
        }
        alert(mensaje);   
    }else{
...
function createRow(numgr, nomd, horai, horaf, salon, disp, profesor) {
    var row = document.createElement("tr");
    row.setAttribute("id", FEC_PREFIX + numgr);
    row.appendChild(createCellWithText(numgr, "10%"));
    row.appendChild(createCellWithText(nomd, "10%"));
    row.appendChild(createCellWithText(horai, "10%"));
    row.appendChild(createCellWithText(horaf, "10%"));
    row.appendChild(createCellWithText(salon, "15%"));
    row.appendChild(createCellWithText(disp, "10%"));
    row.appendChild(createCellWithText(profesor, ""));
    return row;
}

function createCellWithText(text, tam) {
    var cell = document.createElement("td");
    cell.setAttribute("width", tam);
...
function LimpiarTabla()
{
    var List = document.getElementById("List");
    var i;
    document.getElementById("ListSpan").style.display = "";
           ...
           %>
                    <tr> 
                      ...
                      <td width="100"> 
                        ...
                        <div align="center"><a href="#" onclick="refreshModelList('<%=nemonico1%>')"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=texto[j+1]%></font></a></div>
                      </td>
                      <td width="60"> 
...
j=j+1;}%>
			...
			<!--table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><span id="ListSpan" style="display:none;">
                <table width="100%" border="1" class="comun">
                    <tr>
                        <td width="10%"><font color="#990000"><strong>Grupo</strong></font></td>
                        <td width="10%"><font color="#990000"><strong>Dia: </strong></font></td>
                        <td width="10%"><font color="#990000"><strong>Inicio: </strong></font></td>
                        <td width="10%"><font color="#990000"><strong>Fin: </strong></font></td>
                        <td width="15%"><font color="#990000"><strong>Salon:</strong></font></td>
                        <td width="10%"><font color="#990000"><strong>Disponible:</strong></font></td>
                        <td width=""><font color="#990000"><strong>Profesor:</strong></font></td>
                    </tr>
                </table>
                <table width="100%" id="dynamicUpdateArea" align="left" border="1" class="comun">
                    <tbody id="List">
                        <tr id="row0"><td width="10%"></td><td width="15%"></td><td width="25%"></td><td></td></tr>
                    </tbody>
                </table>
            </span></td>
  </tr>
...
%>
    ...
    <tr>
      <td colspan="3"><img src="img/bararhoriz.gif" width="640" height="5"></td>
    </tr>
</table>
