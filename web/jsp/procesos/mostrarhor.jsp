                    ...
                    <td colspan="2">
                        <div class="info" align="center">
                            <h2><font color="#666666">
                                    ...
                                    <br>
                                    <label id="msj2"><b>TENGA EN CUENTA QUE SI VA A INSCRIBIR ASIGNATURAS QUE TENGAN LABORATORIO O AUXILIAR, DEBE INGRESAR LOS GRUPOS CORRESPONDIENTES Y NO SOLAMENTE LA TEORICA</b></label>
                                </font></h2>
                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <b><font size="-1">"En caso de no poder inscribir alguna asignatura, requerir un cupo, cambio de grupo y presentar cruce de asignaturas, usted deberá realizar su solicitud de apoyo diligenciando el formulario electrónico en el enlace que se presenta a continuación:  <a href="https://es.surveymonkey.com/r/sspeh162"> CLICK  AQUI</a></font></b>
                            ...
                            <b><font size="-1">"Si usted necesita enviar un correo electrónico a su decano de  <a href="mailto:ambientalhorario@escuelaing.edu.co"> clik aquí</a></font></b>
                            <%}%>
...
que ya tiene en registro.-->
            ...
            <%} else if (texto[0].equals("B")) {
                //CUANDO DICE QUE NO ESTA AUTORIZADO, CREAR ASIGNATURA DE CONTROL (NICOLAS)
            %>
            <p>
