...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            <%if (pilo.equals("S")) {%>
            window.open("html/mensajeicetex.html" , "ventana1" , "width=200,height=50,scrollbars=NO, left=600, top=400") 
            <%}%>
        </script>
        ...
        <div id="container">
            ...
            <form enctype="multipart/form-data" method="post" name="formulario" action="FileUploadEstudiantes">
                ...
                <table align="center" width="535" border="0" cellpadding="0" cellspacing="0" >
                    ...
                    <p align="center"><font color="#990000" size="2"><a href="http://tycho.escuelaing.edu.co/contenido/RenovacionesIcetex.pdf" TARGET="blank">CONSULTE EL INSTRUCTIVO AQUI</a></font></p>
