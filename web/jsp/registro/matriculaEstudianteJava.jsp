...
<%
    ...
    int proced = bdEst.ProcedimientoActas(carnet);
   ...
   <body id="public" style="background-color: white">
        <div id="container">
            <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla">
                        ...
                        <fieldset><legend>Escuela
                            ...
                            <form name="form1" method="post" action="firmaactaJava">
                                ...
                                <p align="left">De acuerdo al art&iacute;culo
                                    ...
                                    el segundo per&iacute;odo del a&ntilde;o 2020
                                    ...
                                    el primer per&iacute;odo
                                    del a&ntilde;o.</p>
                                <p align="left" >Renovaci&oacute;n de Matr&iacute;cula <!--Intersemestral--> &#8211; <strong>2020-2</strong>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td colspan="5"><div align="justify"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Por
                                                ...
                                                la matr&iacute;cula
                                                para el segundo per&iacute;odo acad&eacute;mico <!--per&iacute;odo intermedio--> 2020
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Renovaci&oacute;n
                                                de matr&iacute;cula para 2020-2</font><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                                    ...
                                    <tr bgcolor="#F0F0F0">
                                        <td>
                                            <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><b>ACTA
                                                    DE MATRICULA PARA: <%=acta.getNomDpto()%> &nbsp;2020-2</b></font></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                ...
                <%
                    String valor = "n";
                    firma = (String) acta.getValRen().concat("-");
